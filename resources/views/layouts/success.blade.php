<!DOCTYPE html>
<html data-theme="light" class='scroll-smooth' lang="{{ str_replace('_', '-', app()->getLocale()) }}">
...
<body>
    ...
    <div
        class="print:hidden absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]">
